...
export const Profile = () => {
  ...
  const { userData, formik: finalFormik } = useFormCV();
  ...
  const formik = useFormik<ProfileData>({
    initialValues: {
      ...
      role: {
        fr: userData.data?.role.fr ?? "",
        en: userData.data?.role.en ?? "",
      },
      description: {
        fr: userData.data?.description.fr ?? "",
        en: userData.data?.description.en ?? "",
      },
    },
