...
import { useSetImageProfileStorage } from '@/core/storage/useSetImageProfileStorage'
...
import { useDeleteImageProfileStorage } from '@/core/storage/useDeleteImageProfileStorage'
import { SectionTextarea } from '@/features/section/containers/section-textarea'
          ...
          <Stack direction={'column'} gap={'1rem'} flex={1}>
            ...
            <Stack direction={'row'} flexWrap={'wrap'} gap={2}>
              <FormControl>
                ...
                <Select
                  name="grade"
                  value={formik.values.grade ? formik.values.grade : null}
                  onChange={(_, value) => {
              ...
              <FormControl sx={{ flex: 1 }}>
                ...
                <Select
                  name="entity"
                  value={formik.values.entity ? formik.values.entity : null}
                  onChange={(_, value) => {
          ...
          <Stack ml={2} gap={1}>
            ...
            <Stack gap={1}>
              ...
              <Typography
                level="body-sm"
                fontWeight={400}
                visibility={formik.values.picture ? 'visible' : 'hidden'}
