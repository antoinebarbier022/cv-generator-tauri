...
import { useSetDataStorage } from '@/core/storage/useSetDataStorage'

import { ResumeValidationSchemaForImportation } from '@/shared/validations/dataContentValidationSchema'
import { CheckRounded, ContentCopy, UpdateRounded } from '@mui/icons-material'
import { Button, Card, Modal, ModalClose, ModalDialog, Stack, Typography } from '@mui/joy'
...
export const DebugModal = (props: Props) => {
  ...
  return (
    <Modal open={props.open} onClose={props.onClose}>
      <ModalDialog sx={{ minWidth: { sm: '80vw', lg: '60vw' }, maxWidth: { sm: '80vw' } }}>
        <ModalClose />
        <Stack>
          ...
          >
            {format(fromUnixTime(data.dataUpdatedAt / 1000), 'dd/MM/yyyy HH:mm')}
          </Typography>
        </Stack>

        <Card component={Stack} sx={{ overflowY: 'auto', position: 'relative' }} className="group">
        ...
        <Stack direction={'row'} gap={1}>
          ...
          <Button
            ...
            onClick={() => handleCopyToClipboard(JSON.stringify(data.data, null, 2))}
          >
